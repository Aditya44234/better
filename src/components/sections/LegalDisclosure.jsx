...
export function LegalDisclosure() {
  return (
    <section className="bg-white text-gray-700 text-[8px] py-8 px-6 md:px-12 lg:px-24 leading-relaxed">
      <div className="max-w-screen-lg mx-auto space-y-4">
        ...
        <p>
          2 Better Mortgage’s One Day HELOC™ promotion offers qualified
          customers who provide certain required financial
          information/documentation to Better Mortgage within 4 hours of locking
        ...
        <p>
          3 Assumes borrowers are eligible for the Automated Valuation Model
        ...
        <p>
          ...
          Inc — License # 02164055 — provide real estate services; Better Cover,
        ...
        <p>
          ...
          LLC and Better Real Estate, operating in California via its subsidiary
          Better Real Estate California Inc., is a licensed real estate
          brokerage headquartered at 325-41 Chestnut Street, Suite 826,
          Philadelphia, PA 19106. Here is a full listing of Better Real Estate,
          LLC’s license numbers. Better Real Estate, LLC provides access to real
          estate brokerage services via its nationwide network of partner
          brokerages and real estate agents (“Better Real Estate Partner
          Agents”). Equal Housing Opportunity. All rights reserved.
        </p>
        ...
        <p>
          ...
          Pennsylvania Resident Producer Agency. License # 881593. Here is a
        ...
        <p>
          ...
          legal and regulatory requirements. Products not available in all
          states.
        </p>
        <p>
          ...
          trademarks are federally registered with the U.S. Patent and Trademark
          Office. Better Cover is a registered trademark with the U.S. Patent
